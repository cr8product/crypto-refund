...
export default function Home() {
  return (
    <div>
      ...
      <Card title="Go Shopping" image="https://www.flaticon.com/free-icon/online-shopping_3081559?term=shopping&page=1&position=4&origin=search&related_id=3081559" description=" Go Shopping" button="More"/>
